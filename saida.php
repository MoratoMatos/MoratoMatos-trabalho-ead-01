...
<html>
  ...
  <body>
    ...
    <table>
      ...
      <tr>
        <td> 
          <?php echo $integrante1Nome; ?>	
        </td>
        <td> 
          <?php echo $integrante1Data; ?>	
        </td>
        <td> 
          <?php echo $integrante1Instrumento; ?>	
        </td>
      </tr>

      <tr>
        <td> 
          <?php echo $integrante2Nome; ?>	
        </td>
        <td> 
          <?php echo $integrante2Data; ?>	
        </td>
        <td> 
          <?php echo $integrante2Instrumento; ?>	
        </td>
      </tr>

      <tr>
        <td> 
          <?php echo $integrante3Nome; ?>	
        </td>
        <td> 
          <?php echo $integrante3Data; ?>	
        </td>
        <td> 
          <?php echo $integrante3Instrumento; ?>
        </td>
      </tr>
